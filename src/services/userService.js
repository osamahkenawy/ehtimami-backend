...
const updateUserProfile = async (userId, rawPayload) => {
  ...
  const { firstName, lastName, phone, email, ...profileFields } = payload;
  ...
  if (profileFields.birth_date)
    profileFields.birth_date = new Date(profileFields.birth_date);
  if (profileFields.join_date)
    profileFields.join_date = new Date(profileFields.join_date);
